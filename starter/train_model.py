...
from ml.model import train_model, compute_model_metrics, compute_roc_curve, compute_metrics_on_slices
import joblib
...
precision, recall, fbeta = compute_model_metrics(
    y=y_test, preds=predictions_on_test)
...
slices_df = slices_df.sort_values(
    by=['recall', 'precision', 'fbeta'])  # ascending=False
slices_df.to_csv(
